                ...
                <div class="container" style="margin-bottom: 60px; width: 100%">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="profile">
                            ...
                            <form action="${pageContext.request.contextPath}/newjsp1.jsp">
                            ...
                            <sql:query var="subjects" dataSource="jdbc/ILGAS">
                                ...
                                <strong>Select a Publisher:</strong>
...
<!--                            <sql:query var="company" dataSource="jdbc/ILGAS">
                                SELECT Company_Number, Company FROM international_publishers
                                ORDER BY LEFT(Company, 3) WHERE Company = ?
                                <sql:param value="${publisher}" />
                            </sql:query>
                            <br/>results2 <div id="results2"></div>
                            <br/>-->
<!--                            <label>
                                Enter name: 
                                <input id="name" />
