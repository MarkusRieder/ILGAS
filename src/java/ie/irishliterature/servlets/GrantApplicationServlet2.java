...
@WebServlet(name = "GrantApplicationServlet2", urlPatterns = {"/GrantApplicationServlet2"})
public class GrantApplicationServlet2 extends HttpServlet {
