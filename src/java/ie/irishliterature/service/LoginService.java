...
public class LoginService {
    ...
    public String[] loginCheck(String username, String password, long lastLogonForm) {
        ...
        try {
            ...
            PreparedStatement pst = conn.prepareStatement("Select userID, uname, lastLogon, first_name, last_name,password,email,function,role  FROM users WHERE uname=? AND password=?");
