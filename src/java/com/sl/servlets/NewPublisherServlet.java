...
public class NewPublisherServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = ("UPDATE international_publishers SET Company = ?, Address1 = ?, Address2 = ?, Address3 = ?, Address4 = ?, postCode = ?, City = ?, Country = ?, CountryCode = ?, Email = ?, Telephone = ?, Fax = ?, WWW = ?, DONOTMAIL = ?, Bursaries = ?, Founded = ?, NumberOfTitles = ?, Notes = ?, Status = ? WHERE Company_Number = ?");
